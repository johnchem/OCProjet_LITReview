...
urlpatterns = [
    ...
    path('update/<str:post_name>', creation_views.updateTicketView.as_view(), name='update_ticket'),
    path('update/<str:post_name>', creation_views.updateReviewView.as_view(), name='update_review'),
